...
class Controllers {
    ...
    class func exerciseImageViewerViewController(parent: ExerciseImageViewerViewControllerDelegate?) -> ExerciseImageViewerViewController {
        let viewController = ExerciseImageViewerViewController(parent: parent)
